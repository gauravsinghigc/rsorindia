...
$PageName = "Latest News & Updates " . APP_NAME;
    ...
    <section class="container pt-4 pb-3">
        <div class="row">
            <div class="col-md-12 text-center mb-4">
                <h4>Search recent blogs, new, updates</h4>
                <form class="w-75 d-block mx-auto mt-2">
                    <input type="search" class="form-control form-control-lg" placeholder="Search News, Update and blogs..." name="SearchNewsAndUpdates" onchange="form.submit()">
                </form>
                <hr>
            </div>
            <?php

...
$PageName = "My Dashboard @ " . APP_NAME;
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row mt-3">
                    <div class="col-md-4">
                        <a href="">
                            <div class="rsor-card p-2 shadow-sm rounded">
                                <h2 class="rsor-text">0</h2>
                                <p class="mb-0 small">All Published Work</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <a href="">
                            <div class="rsor-card p-2 shadow-sm rounded">
                                <h2 class="rsor-text">0</h2>
                                <p class="mb-0 small">All Invoices</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="">
                            <div class="rsor-card p-2 shadow-sm rounded">
                                <h2 class="rsor-text">0</h2>
                                <p class="mb-0 small">Invoice Amount</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="">
                            <div class="rsor-card p-2 shadow-sm rounded">
                                <h2 class="rsor-text">0</h2>
                                <p class="mb-0 small">Open Queries</p>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="">
                            <div class="rsor-card p-2 shadow-sm rounded">
                                <h2 class="rsor-text">0</h2>
                                <p class="mb-0 small">Unread Notifications</p>
                            </div>
                        </a>
                    </div>
                </div>

        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                <div class="shadow-sm p-3 rounded d-block">
                    <h5><i class='fa fa-table text-danger'></i> All <span class='rsor-text'>Orders</span></h5>
                    <hr class="mt-1 mb-1">
                    <form>
                    ...
                    <ul class="rsor-lists">
                        ...
                        <li>
                            <a href="">
                                <span class="small text-secondary">ID : 3</span>
                                <span class="pull-right fs-11 text-secondary"><i class="fa fa-calendar"></i> 30 October 2024</span>
                                <h6 class="fs-13 mt-0">1bhk House painting</h6>
                                <p class="fs-12 mb-0 flex-s-b">
                                    <span>
                        ...
                        <li>
                            <a href="">
                                <span class="small text-secondary">ID : 4</span>
                                <span class="pull-right fs-11 text-secondary"><i class="fa fa-calendar"></i> 30 October 2024</span>
                                <h6 class="fs-13 mt-0">1bhk House painting</h6>
                                <p class="fs-12 mb-0 flex-s-b">
                                    <span>
                ...
                <div class="shadow-sm p-2 rounded">
                    <div>
                        ...
                        <a href="" class='btn btn-sm btn-dark'>
                            <i class="fa fa-file-pdf-o"></i> View Activities
                        </a>
                        <a href="" class='btn btn-sm btn-info'>
                            <i class="fa fa-briefcase"></i> View Vendor
                        </a>
                    </div>
                    <hr>
                    <h5 class="mb-2">Order Details <span class="text-secondary small font-weight-normal">(ID: 1234)</span></h5>
                    ...
                    <div>
                        ...
                        <p class='fs-13 mb-3 mt-2'>
                            <span class='text-secondary'>Managed By</span><br>
                            <span class="rsor-text fs-15">ABC Service Pvt Ltd
                                <span class="text-secondary fs-11">(ID: 23456)</span>
                            </span>
                        </p>
                    </div>
